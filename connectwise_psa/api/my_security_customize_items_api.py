...
class MySecurityCustomizeItemsApi:
    ...
    @validate_call
    def get_system_my_security_customize_items(
        self,
        client_id: StrictStr,
        ...
        _param = self._get_system_my_security_customize_items_serialize(
            client_id=client_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[MySecurityCustomizeItem]"
    ...
    @validate_call
    def get_system_my_security_customize_items_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[MySecurityCustomizeItem]]:
        """Get List of MySecurityCustomizeItems
    ...
    @validate_call
    def get_system_my_security_customize_items_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_my_security_customize_items_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/mySecurity/customizeItems/',
