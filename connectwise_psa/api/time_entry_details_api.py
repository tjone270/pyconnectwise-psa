...
class TimeEntryDetailsApi:
    ...
    @validate_call
    def get_time_entries_by_parent_id_details(
        self,
        ...
        _param = self._get_time_entries_by_parent_id_details_serialize(
            parent_id=parent_id,
            client_id=client_id,
    ...
    @validate_call
    def get_time_entries_by_parent_id_details_with_http_info(
        self,
        parent_id: Annotated[StrictInt, Field(description="entryId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_time_entries_by_parent_id_details_without_preload_content(
        self,
        parent_id: Annotated[StrictInt, Field(description="entryId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_time_entries_by_parent_id_details_serialize(
        self,
        parent_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/time/entries/{parentId}/Details',
