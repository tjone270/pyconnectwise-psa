...
class ManagementLogsApi:
    ...
    @validate_call
    def get_company_management_by_id_log_download(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        file_path: Annotated[StrictStr, Field(description="filePath")],
        ...
        :type client_id: str
        :param file_path: filePath (required)
        :type file_path: str
        :param conditions: 
        :type conditions: str
        ...
        _param = self._get_company_management_by_id_log_download_serialize(
            id=id,
            client_id=client_id,
            file_path=file_path,
    ...
    @validate_call
    def get_company_management_by_id_log_download_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        file_path: Annotated[StrictStr, Field(description="filePath")],
    ...
    @validate_call
    def get_company_management_by_id_log_download_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        file_path: Annotated[StrictStr, Field(description="filePath")],
    ...
    def _get_company_management_by_id_log_download_serialize(
        self,
        id,
        client_id,
        file_path,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/company/management/{id}/log/download',
    ...
    @validate_call
    def get_company_management_by_id_logs(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_company_management_by_id_logs_serialize(
            id=id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ManagementLogDocumentInfo]"
    ...
    @validate_call
    def get_company_management_by_id_logs_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ManagementLogDocumentInfo]]:
        """Get List of ManagementLogDocumentInfo
    ...
    @validate_call
    def get_company_management_by_id_logs_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="managementId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_company_management_by_id_logs_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/company/management/{id}/logs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
