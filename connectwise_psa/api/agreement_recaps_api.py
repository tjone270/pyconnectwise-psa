...
class AgreementRecapsApi:
    ...
    @validate_call
    def get_finance_agreementrecap(
        self,
        client_id: StrictStr,
        ...
        _param = self._get_finance_agreementrecap_serialize(
            client_id=client_id,
    ...
    @validate_call
    def get_finance_agreementrecap_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AgreementRecap]]:
        """Get List of AgreementRecaps
    ...
    @validate_call
    def get_finance_agreementrecap_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_finance_agreementrecap_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/finance/agreementrecap/',
    ...
    @validate_call
    def get_finance_agreementrecap_by_id(
        self,
        id: Annotated[StrictInt, Field(description="AgreementRecapId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        custom_field_conditions: Optional[StrictStr] = None,
        ...
        :param id: AgreementRecapId (required)
        :type id: int
        :param client_id:  (required)
        :type client_id: str
        :param conditions: 
        ...
        _param = self._get_finance_agreementrecap_by_id_serialize(
            id=id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
    ...
    @validate_call
    def get_finance_agreementrecap_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="AgreementRecapId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_finance_agreementrecap_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="AgreementRecapId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_finance_agreementrecap_by_id_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/finance/agreementrecap/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
