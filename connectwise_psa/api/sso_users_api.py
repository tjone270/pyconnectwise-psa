...
class SsoUsersApi:
    ...
    def get_system_sso_users(
        ...
        _param = self._get_system_sso_users_serialize(
            client_id=client_id,
    ...
    @validate_call
    def get_system_sso_users_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_sso_users_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_sso_users_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
    ...
    @validate_call
    def get_system_sso_users_by_external_id(
        self,
        external_id: Annotated[StrictInt, Field(description="externalId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        custom_field_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_system_sso_users_by_external_id_serialize(
    ...
    @validate_call
    def get_system_sso_users_by_external_id_with_http_info(
        self,
        external_id: Annotated[StrictInt, Field(description="externalId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_sso_users_by_external_id_without_preload_content(
        self,
        external_id: Annotated[StrictInt, Field(description="externalId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_sso_users_by_external_id_serialize(
        self,
        external_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/ssoUsers/{externalId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_system_sso_users_count(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_system_sso_users_count_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_system_sso_users_count_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_sso_users_count_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_sso_users_count_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/ssoUsers/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
