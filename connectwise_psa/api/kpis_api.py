...
class KPIsApi:
    ...
    def get_system_kpis(
        ...
        _param = self._get_system_kpis_serialize(
            client_id=client_id,
    ...
    @validate_call
    def get_system_kpis_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_kpis_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_kpis_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
    ...
    @validate_call
    def get_system_kpis_by_id(
        self,
        id: Annotated[StrictInt, Field(description="kpiId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        custom_field_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_system_kpis_by_id_serialize(
            id=id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
    ...
    @validate_call
    def get_system_kpis_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="kpiId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_kpis_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="kpiId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_kpis_by_id_serialize(
        self,
        id,
        client_id,
        conditions,
    ...
    def get_system_kpis_count(
        ...
        _param = self._get_system_kpis_count_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_system_kpis_count_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_kpis_count_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_kpis_count_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/kpis/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
