...
class ExpenseTaxTypeInfosApi:
    ...
    @validate_call
    def get_expense_info_tax_types(
        self,
        client_id: StrictStr,
        ...
        _param = self._get_expense_info_tax_types_serialize(
            client_id=client_id,
    ...
    @validate_call
    def get_expense_info_tax_types_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ExpenseTaxTypeInfo]]:
        """Get List of ExpenseTaxTypeInfo
    ...
    @validate_call
    def get_expense_info_tax_types_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_expense_info_tax_types_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/expense/info/taxTypes',
    ...
    @validate_call
    def get_expense_info_tax_types_by_id(
        self,
        id: Annotated[StrictInt, Field(description="taxTypeId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        custom_field_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_expense_info_tax_types_by_id_serialize(
            id=id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
    ...
    @validate_call
    def get_expense_info_tax_types_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="taxTypeId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpenseTaxTypeInfo]:
        """Get ExpenseTaxTypeInfo
    ...
    @validate_call
    def get_expense_info_tax_types_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="taxTypeId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_expense_info_tax_types_by_id_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/expense/info/taxTypes/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_expense_info_tax_types_count(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_expense_info_tax_types_count_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_expense_info_tax_types_count_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_expense_info_tax_types_count_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_expense_info_tax_types_count_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/expense/info/taxTypes/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
