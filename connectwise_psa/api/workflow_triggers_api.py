...
class WorkflowTriggersApi:
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers(
        self,
        ...
        _param = self._get_system_workflows_by_parent_id_triggers_serialize(
            parent_id=parent_id,
            client_id=client_id,
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers_with_http_info(
        self,
        parent_id: Annotated[StrictInt, Field(description="workflowId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[WorkflowTrigger]]:
        """Get List of WorkflowTrigger
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers_without_preload_content(
        self,
        parent_id: Annotated[StrictInt, Field(description="workflowId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_workflows_by_parent_id_triggers_serialize(
        self,
        parent_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/workflows/{parentId}/triggers',
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers_count(
        self,
        parent_id: Annotated[StrictInt, Field(description="workflowId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_system_workflows_by_parent_id_triggers_count_serialize(
            parent_id=parent_id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers_count_with_http_info(
        self,
        parent_id: Annotated[StrictInt, Field(description="workflowId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_workflows_by_parent_id_triggers_count_without_preload_content(
        self,
        parent_id: Annotated[StrictInt, Field(description="workflowId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_workflows_by_parent_id_triggers_count_serialize(
        self,
        parent_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/workflows/{parentId}/triggers/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
