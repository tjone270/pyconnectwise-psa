...
class CwTimeZonesApi:
    ...
    def get_system_cw_time_zones(
        ...
        _param = self._get_system_cw_time_zones_serialize(
            client_id=client_id,
    ...
    @validate_call
    def get_system_cw_time_zones_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_cw_time_zones_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_cw_time_zones_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/cwTimeZones',
    ...
    @validate_call
    def get_system_cw_time_zones_by_id(
        self,
        id: Annotated[StrictInt, Field(description="cwTimeZoneId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        custom_field_conditions: Optional[StrictStr] = None,
        ...
        :param id: cwTimeZoneId (required)
        :type id: int
        :param client_id:  (required)
        :type client_id: str
        :param conditions: 
        ...
        _param = self._get_system_cw_time_zones_by_id_serialize(
            id=id,
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
    ...
    @validate_call
    def get_system_cw_time_zones_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="cwTimeZoneId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_cw_time_zones_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="cwTimeZoneId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_cw_time_zones_by_id_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/cwTimeZones/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_system_cw_time_zones_count(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_system_cw_time_zones_count_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_system_cw_time_zones_count_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_cw_time_zones_count_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_system_cw_time_zones_count_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/cwTimeZones/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
