...
class ProjectStatusesInfoApi:
    ...
    @validate_call
    def get_project_statuses_by_id_info(
        self,
        id: Annotated[StrictInt, Field(description="ProjectStatusInfoId")],
        client_id: StrictStr,
        ...
        :param id: ProjectStatusInfoId (required)
        :type id: int
        ...
        _param = self._get_project_statuses_by_id_info_serialize(
            id=id,
            client_id=client_id,
    ...
    @validate_call
    def get_project_statuses_by_id_info_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ProjectStatusInfoId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_project_statuses_by_id_info_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ProjectStatusInfoId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_project_statuses_by_id_info_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/statuses/{id}/info',
    ...
    def get_project_statuses_info(
        ...
        _param = self._get_project_statuses_info_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_project_statuses_info_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectStatusInfo]]:
        """Get List of ProjectStatusesInfo
    ...
    @validate_call
    def get_project_statuses_info_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_project_statuses_info_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/statuses/info',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_project_statuses_info_count(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
        ...
        _param = self._get_project_statuses_info_count_serialize(
            client_id=client_id,
            conditions=conditions,
            child_conditions=child_conditions,
            custom_field_conditions=custom_field_conditions,
    ...
    @validate_call
    def get_project_statuses_info_count_with_http_info(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_project_statuses_info_count_without_preload_content(
        self,
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        child_conditions: Optional[StrictStr] = None,
    ...
    def _get_project_statuses_info_count_serialize(
        self,
        client_id,
        conditions,
        child_conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/statuses/info/count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
