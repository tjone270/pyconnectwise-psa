...
class MyAccountsApi:
    ...
    @validate_call
    def get_system_my_account_by_id(
        self,
        ...
        _param = self._get_system_my_account_by_id_serialize(
            id=id,
            client_id=client_id,
    ...
    @validate_call
    def get_system_my_account_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_system_my_account_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_system_my_account_by_id_serialize(
        self,
        id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/system/myAccount/{id}',
    ...
    @validate_call
    def patch_system_my_account_by_id(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        ...
        _param = self._patch_system_my_account_by_id_serialize(
            id=id,
            client_id=client_id,
    ...
    @validate_call
    def patch_system_my_account_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        patch_operation: Annotated[List[PatchOperation], Field(description="List of PatchOperation")],
    ...
    @validate_call
    def patch_system_my_account_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        patch_operation: Annotated[List[PatchOperation], Field(description="List of PatchOperation")],
    ...
    def _patch_system_my_account_by_id_serialize(
        self,
        id,
        client_id,
        patch_operation,
    ...
    @validate_call
    def put_system_my_account_by_id(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        my_account: Annotated[MyAccount, Field(description="myAccount")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param client_id:  (required)
        :type client_id: str
        :param my_account: myAccount (required)
        :type my_account: MyAccount
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_system_my_account_by_id_serialize(
            id=id,
            client_id=client_id,
    ...
    @validate_call
    def put_system_my_account_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        my_account: Annotated[MyAccount, Field(description="myAccount")],
    ...
    @validate_call
    def put_system_my_account_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="memberId")],
        client_id: StrictStr,
        my_account: Annotated[MyAccount, Field(description="myAccount")],
    ...
    def _put_system_my_account_by_id_serialize(
        self,
        id,
        client_id,
        my_account,
