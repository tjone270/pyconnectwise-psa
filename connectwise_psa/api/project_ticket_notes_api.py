...
class ProjectTicketNotesApi:
    ...
    @validate_call
    def get_project_tickets_by_parent_id_all_notes(
        self,
        ...
        _param = self._get_project_tickets_by_parent_id_all_notes_serialize(
            parent_id=parent_id,
            client_id=client_id,
    ...
    @validate_call
    def get_project_tickets_by_parent_id_all_notes_with_http_info(
        self,
        parent_id: Annotated[StrictInt, Field(description="ticketId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ProjectTicketNote]]:
        """Get List of ProjectTicketNote
    ...
    @validate_call
    def get_project_tickets_by_parent_id_all_notes_without_preload_content(
        self,
        parent_id: Annotated[StrictInt, Field(description="ticketId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_project_tickets_by_parent_id_all_notes_serialize(
        self,
        parent_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/project/tickets/{parentId}/allNotes',
    ...
    @validate_call
    def post_project_ticket_note_by_id_mark_as(
        self,
        id: Annotated[StrictInt, Field(description="ticketNoteId")],
        client_id: StrictStr,
        project_ticket_note: Annotated[ProjectTicketNote, Field(description="item")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ticketNoteId (required)
        :type id: int
        :param client_id:  (required)
        :type client_id: str
        :param project_ticket_note: item (required)
        :type project_ticket_note: ProjectTicketNote
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_project_ticket_note_by_id_mark_as_serialize(
            id=id,
            client_id=client_id,
            project_ticket_note=project_ticket_note,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_project_ticket_note_by_id_mark_as_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ticketNoteId")],
        client_id: StrictStr,
        project_ticket_note: Annotated[ProjectTicketNote, Field(description="item")],
    ...
    @validate_call
    def post_project_ticket_note_by_id_mark_as_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ticketNoteId")],
        client_id: StrictStr,
        project_ticket_note: Annotated[ProjectTicketNote, Field(description="item")],
    ...
    def _post_project_ticket_note_by_id_mark_as_serialize(
        self,
        id,
        client_id,
        project_ticket_note,
        ...
        # process the form parameters
        # process the body parameter
        if project_ticket_note is not None:
            _body_params = project_ticket_note
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/project/ticketNote/{id}/markAs/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
