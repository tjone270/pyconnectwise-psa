...
class ServiceTicketNotesApi:
    ...
    @validate_call
    def get_service_tickets_by_parent_id_all_notes(
        self,
        ...
        _param = self._get_service_tickets_by_parent_id_all_notes_serialize(
            parent_id=parent_id,
            client_id=client_id,
    ...
    @validate_call
    def get_service_tickets_by_parent_id_all_notes_with_http_info(
        self,
        parent_id: Annotated[StrictInt, Field(description="ticketId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ServiceTicketNote]]:
        """Get List of ServiceTicketNote
    ...
    @validate_call
    def get_service_tickets_by_parent_id_all_notes_without_preload_content(
        self,
        parent_id: Annotated[StrictInt, Field(description="ticketId")],
        client_id: StrictStr,
        conditions: Optional[StrictStr] = None,
    ...
    def _get_service_tickets_by_parent_id_all_notes_serialize(
        self,
        parent_id,
        client_id,
        conditions,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/service/tickets/{parentId}/allNotes',
