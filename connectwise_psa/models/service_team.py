...
class ServiceTeam(BaseModel):
    ...
    delete_notify_flag: Optional[StrictBool] = Field(default=None, alias="deleteNotifyFlag")
    department: Optional[SystemDepartmentReference] = None
    id: Optional[StrictInt] = None
    leader: Optional[MemberReference] = None
    location: Optional[SystemLocationReference] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_info", "deleteNotifyFlag", "department", "id", "leader", "location", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if delete_notify_flag (nullable) is None
        # and model_fields_set contains the field
        if self.delete_notify_flag is None and "delete_notify_flag" in self.model_fields_set:
            _dict['deleteNotifyFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ServiceTeam) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "deleteNotifyFlag": obj.get("deleteNotifyFlag"),
            "department": SystemDepartmentReference.from_dict(obj.get("department")) if obj.get("department") is not None else None,
            "id": obj.get("id"),
            "leader": MemberReference.from_dict(obj.get("leader")) if obj.get("leader") is not None else None,
