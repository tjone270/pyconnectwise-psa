...
class AccountingPackageReference(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "id", "identifier", "name"]
    ...
    def identifier_validate_enum(cls, value):
        ...
        if value not in ('QB99', 'Mas200', 'GPlains', 'SBA', 'Mas200v4', 'Other'):
            raise ValueError("must be one of enum values ('QB99', 'Mas200', 'GPlains', 'SBA', 'Mas200v4', 'Other')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AccountingPackageReference) in the input: " + _key)
