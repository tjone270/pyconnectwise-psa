...
class BillingTerm(BaseModel):
    ...
    due_days: Optional[StrictInt] = Field(alias="dueDays")
    id: Optional[StrictInt] = None
    name: StrictStr = Field(description=" Max length: 50;")
    terms_xref: Optional[StrictStr] = Field(default=None, description=" Max length: 50;", alias="termsXref")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "dueDays", "id", "name", "termsXref"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BillingTerm) in the input: " + _key)
