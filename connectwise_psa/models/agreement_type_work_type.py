...
class AgreementTypeWorkType(BaseModel):
    ...
    overage_rate_type: Optional[StrictStr] = Field(alias="overageRateType")
    ...
    __properties: ClassVar[List[str]] = ["_info", "billTime", "effectiveDate", "endingDate", "hoursMax", "hoursMin", "id", "limitTo", "overageRate", "overageRateType", "rate", "rateType", "roundBillHours", "type", "workType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AgreementTypeWorkType) in the input: " + _key)
