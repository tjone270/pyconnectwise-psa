...
class AutoSyncTime(BaseModel):
    ...
    sync_time: StrictStr = Field(alias="syncTime")
    time_zone: Optional[TimeZoneSetupReference] = Field(default=None, alias="timeZone")
    __properties: ClassVar[List[str]] = ["_info", "id", "syncTime", "timeZone"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AutoSyncTime) in the input: " + _key)
