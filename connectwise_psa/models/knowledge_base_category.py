...
class KnowledgeBaseCategory(BaseModel):
    ...
    approver: Optional[MemberReference] = None
    ...
    __properties: ClassVar[List[str]] = ["_info", "approver", "department", "id", "location", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in KnowledgeBaseCategory) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "approver": MemberReference.from_dict(obj.get("approver")) if obj.get("approver") is not None else None,
