...
class OpportunityToSalesOrderConversion(BaseModel):
    ...
    sales_order_id: Optional[StrictInt] = Field(default=None, alias="salesOrderId")
    __properties: ClassVar[List[str]] = ["includeAllDocumentsFlag", "includeAllNotesFlag", "includeAllProductsFlag", "includeDocumentIds", "includeNoteIds", "includeProductIds", "name", "salesOrderId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OpportunityToSalesOrderConversion) in the input: " + _key)
