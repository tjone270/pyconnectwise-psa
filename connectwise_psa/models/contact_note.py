...
class ContactNote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "contactId", "enteredBy", "flagged", "id", "text", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ContactNote) in the input: " + _key)
