...
class PhaseStatus(BaseModel):
    ...
    board_association_ids: Optional[List[StrictInt]] = Field(default=None, alias="boardAssociationIds")
    closed_flag: Optional[StrictBool] = Field(default=None, alias="closedFlag")
    collapsed_flag: Optional[StrictBool] = Field(default=None, alias="collapsedFlag")
    custom_status_indicator_name: Optional[StrictStr] = Field(default=None, description="Required when statusIndicator is Custom. Max length: 30;", alias="customStatusIndicatorName")
    ...
    __properties: ClassVar[List[str]] = ["_info", "boardAssociationIds", "closedFlag", "collapsedFlag", "customStatusIndicatorName", "defaultFlag", "id", "inactiveFlag", "name", "statusIndicator"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if collapsed_flag (nullable) is None
        # and model_fields_set contains the field
        if self.collapsed_flag is None and "collapsed_flag" in self.model_fields_set:
            _dict['collapsedFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PhaseStatus) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "boardAssociationIds": obj.get("boardAssociationIds"),
            "closedFlag": obj.get("closedFlag"),
            "collapsedFlag": obj.get("collapsedFlag"),
