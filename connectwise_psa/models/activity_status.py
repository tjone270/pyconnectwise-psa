...
class ActivityStatus(BaseModel):
    ...
    spawn_followup_flag: Optional[StrictBool] = Field(default=None, alias="spawnFollowupFlag")
    __properties: ClassVar[List[str]] = ["_info", "closedFlag", "defaultFlag", "id", "inactiveFlag", "name", "spawnFollowupFlag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if spawn_followup_flag (nullable) is None
        # and model_fields_set contains the field
        if self.spawn_followup_flag is None and "spawn_followup_flag" in self.model_fields_set:
            _dict['spawnFollowupFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ActivityStatus) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "spawnFollowupFlag": obj.get("spawnFollowupFlag")
        })
        return _obj
