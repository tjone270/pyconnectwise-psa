...
class GLExportPurchaseTransactionDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountNumber", "cogsXref", "cost", "costAccountNumber", "currency", "description", "documentDate", "dropShippedFlag", "glClass", "glItemId", "glTypeId", "id", "inventoryAccountNumber", "inventoryXref", "item", "itemCost", "itemDescription", "itemPrice", "itemTypeXref", "lineNumber", "locationXref", "memo", "priceLevelXref", "purchaseHeaderTaxGroup", "quantity", "salesCode", "salesDescription", "serialNumbers", "serializedFlag", "shipmentMethod", "subCategory", "taxAgencyXref", "taxCode", "taxCodeXref", "taxNote", "taxRate", "taxable", "total", "unitOfMeasure", "uomScheduleXref", "vendorAccountNumber", "vendorNumber", "warehouseBin", "warehouseSite"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GLExportPurchaseTransactionDetail) in the input: " + _key)
