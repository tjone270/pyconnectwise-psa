...
class UserDefinedFieldInfo(BaseModel):
    ...
    business_unit_ids: Optional[List[StrictInt]] = Field(default=None, description="List of business unit ids using custom field", alias="businessUnitIds")
    button_url: Optional[StrictStr] = Field(default=None, description="Only available with Button Field Type. Required when entryTypeIdentifier is button", alias="buttonUrl")
    caption: Optional[StrictStr] = Field(default=None, description="Field caption")
    date_created: Optional[StrictStr] = Field(default=None, description="Date in UTC the custom field was created", alias="dateCreated")
    ...
    field_type_identifier: Optional[StrictStr] = Field(default=None, alias="fieldTypeIdentifier")
    help_text: Optional[StrictStr] = Field(default=None, description="Help text to accompany the custom field", alias="helpText")
    ...
    location_ids: Optional[List[StrictInt]] = Field(default=None, description="List of locations ids using custom field", alias="locationIds")
    ...
    pod_id: Optional[StrictInt] = Field(default=None, description="Id of the Pod where the custom field will be placed", alias="podId")
    ...
    sequence_number: Optional[StrictInt] = Field(default=None, description="Must be between 1 and 500.  This defines the order in which the custom fields will appear", alias="sequenceNumber")
    __properties: ClassVar[List[str]] = ["_info", "businessUnitIds", "buttonUrl", "caption", "dateCreated", "displayOnScreenFlag", "entryTypeIdentifier", "fieldTypeIdentifier", "helpText", "id", "listViewFlag", "locationIds", "numberDecimals", "options", "podId", "readOnlyFlag", "requiredFlag", "sequenceNumber"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UserDefinedFieldInfo) in the input: " + _key)
