...
class ProjectStatus(BaseModel):
    ...
    no_time_flag: Optional[StrictBool] = Field(default=None, alias="noTimeFlag")
    status_indicator: Optional[StatusIndicatorReference] = Field(default=None, alias="statusIndicator")
    __properties: ClassVar[List[str]] = ["_info", "closedFlag", "customStatusIndicatorName", "defaultFlag", "id", "inactiveFlag", "name", "noTimeFlag", "statusIndicator"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if no_time_flag (nullable) is None
        # and model_fields_set contains the field
        if self.no_time_flag is None and "no_time_flag" in self.model_fields_set:
            _dict['noTimeFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProjectStatus) in the input: " + _key)
