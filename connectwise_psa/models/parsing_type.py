...
class ParsingType(BaseModel):
    ...
    parse_rule: Optional[StrictStr] = Field(default=None, alias="parseRule")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "id", "name", "parseRule"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ParsingType) in the input: " + _key)
