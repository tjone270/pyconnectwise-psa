...
class LocationInfo(BaseModel):
    ...
    location_flag: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    structure_level: Optional[CorporateStructureLevelReference] = Field(default=None, alias="structureLevel")
    __properties: ClassVar[List[str]] = ["_info", "id", "location_flag", "name", "structureLevel"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LocationInfo) in the input: " + _key)
