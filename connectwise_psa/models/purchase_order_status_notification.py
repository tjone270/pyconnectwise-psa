...
class PurchaseOrderStatusNotification(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Purchase Order Status Notification email must be entered if the notify type is \"Email Address\". Max length: 50;")
    ...
    workflow_step: Optional[StrictInt] = Field(default=None, alias="workflowStep")
    __properties: ClassVar[List[str]] = ["_info", "email", "id", "member", "notifyWho", "status", "workflowStep"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if workflow_step (nullable) is None
        # and model_fields_set contains the field
        if self.workflow_step is None and "workflow_step" in self.model_fields_set:
            _dict['workflowStep'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PurchaseOrderStatusNotification) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "workflowStep": obj.get("workflowStep")
        })
        return _obj
