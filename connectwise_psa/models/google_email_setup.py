...
class GoogleEmailSetup(BaseModel):
    ...
    client_id: Optional[StrictStr] = Field(default=None, description=" Max length: 200;", alias="clientId")
    ...
    private_key: Optional[StrictStr] = Field(default=None, description=" Max length: 4000;", alias="privateKey")
    processed_folder: StrictStr = Field(description=" Max length: 40;", alias="processedFolder")
    username: StrictStr = Field(description=" Max length: 100;")
    __properties: ClassVar[List[str]] = ["_info", "clientId", "emailConnector", "failedFolder", "id", "inactiveFlag", "inboxFolder", "name", "privateKey", "processedFolder", "username"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GoogleEmailSetup) in the input: " + _key)
