...
class MarketingContact(BaseModel):
    ...
    note: Optional[StrictStr] = Field(default=None, description=" Max length: 50;")
    unsubscribe_flag: Optional[StrictBool] = Field(default=None, alias="unsubscribeFlag")
    __properties: ClassVar[List[str]] = ["_info", "groupId", "id", "note", "unsubscribeFlag"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MarketingContact) in the input: " + _key)
