...
class ManagementReportNotification(BaseModel):
    ...
    global_flag: Optional[StrictBool] = Field(default=None, alias="globalFlag")
    ...
    __properties: ClassVar[List[str]] = ["_info", "company", "email", "globalFlag", "id", "member", "notifyWho"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if global_flag (nullable) is None
        # and model_fields_set contains the field
        if self.global_flag is None and "global_flag" in self.model_fields_set:
            _dict['globalFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ManagementReportNotification) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "company": CompanyReference.from_dict(obj.get("company")) if obj.get("company") is not None else None,
            "email": obj.get("email"),
            "globalFlag": obj.get("globalFlag"),
            "id": obj.get("id"),
