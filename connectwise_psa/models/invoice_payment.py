...
class InvoicePayment(BaseModel):
    ...
    credit: Optional[InvoiceReference] = None
    ...
    __properties: ClassVar[List[str]] = ["_info", "aRPaymentAccount", "amount", "appliedBy", "credit", "id", "invoice", "paymentAccount", "paymentDate", "paymentSyncDate", "paymentSyncStatus", "source", "type", "wisePayPayment"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InvoicePayment) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "credit": InvoiceReference.from_dict(obj.get("credit")) if obj.get("credit") is not None else None,
            "id": obj.get("id"),
