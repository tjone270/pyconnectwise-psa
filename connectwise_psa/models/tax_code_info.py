...
class TaxCodeInfo(BaseModel):
    ...
    cancel_date: Optional[StrictStr] = Field(default=None, alias="cancelDate")
    description: Optional[StrictStr] = None
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    id: Optional[StrictInt] = None
    identifier: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_info", "cancelDate", "description", "effectiveDate", "id", "identifier"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TaxCodeInfo) in the input: " + _key)
