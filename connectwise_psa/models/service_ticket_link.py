...
class ServiceTicketLink(BaseModel):
    ...
    link_text: StrictStr = Field(description=" Max length: 50;", alias="linkText")
    name: StrictStr = Field(description=" Max length: 50;")
    url: StrictStr = Field(description=" Max length: 1000;")
    __properties: ClassVar[List[str]] = ["_info", "enabledFlag", "id", "linkText", "name", "url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ServiceTicketLink) in the input: " + _key)
