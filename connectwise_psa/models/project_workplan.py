...
class ProjectWorkplan(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["phases", "projectId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProjectWorkplan) in the input: " + _key)

        _obj = cls.model_validate({
            "phases": [ProjectPhase.from_dict(_item) for _item in obj.get("phases")] if obj.get("phases") is not None else None,
