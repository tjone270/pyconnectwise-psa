...
class UnitOfMeasure(BaseModel):
    ...
    uom_schedule_xref: Optional[StrictStr] = Field(default=None, description=" Max length: 31;", alias="uomScheduleXref")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "id", "inactiveFlag", "name", "uomScheduleXref"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UnitOfMeasure) in the input: " + _key)
