...
class EPayConfiguration(BaseModel):
    ...
    encryption_key: Optional[StrictStr] = Field(default=None, description=" Max length: 500;", alias="encryptionKey")
    id: Optional[StrictInt] = None
    initialization_vector: Optional[StrictStr] = Field(default=None, description=" Max length: 500;", alias="initializationVector")
    location: Optional[SystemLocationReference] = None
    store_identifier: StrictStr = Field(description=" Max length: 500;", alias="storeIdentifier")
    url: StrictStr = Field(description=" Max length: 400;")
    __properties: ClassVar[List[str]] = ["_info", "currency", "encryptionKey", "id", "initializationVector", "location", "storeIdentifier", "url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EPayConfiguration) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "storeIdentifier": obj.get("storeIdentifier"),
            "url": obj.get("url")
        })
        return _obj
