...
class ProductTypeExemption(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "id", "productType", "taxableLevels"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ProductTypeExemption) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "id": obj.get("id"),
            "productType": ProductTypeReference.from_dict(obj.get("productType")) if obj.get("productType") is not None else None,
