...
class BulkResult(BaseModel):
    ...
    payload: Optional[List[ResultInfo]] = None
    __properties: ClassVar[List[str]] = ["_info", "payload"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BulkResult) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "payload": [ResultInfo.from_dict(_item) for _item in obj.get("payload")] if obj.get("payload") is not None else None
        })
        return _obj
