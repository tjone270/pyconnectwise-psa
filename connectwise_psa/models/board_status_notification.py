...
class BoardStatusNotification(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Service Status Notification email must be entered if the notify type is \"Email Address\". Max length: 255;")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BoardStatusNotification) in the input: " + _key)
