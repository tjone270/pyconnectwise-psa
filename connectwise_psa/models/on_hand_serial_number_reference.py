...
class OnHandSerialNumberReference(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "id", "serialNumber"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OnHandSerialNumberReference) in the input: " + _key)
