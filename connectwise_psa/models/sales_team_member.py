...
class SalesTeamMember(BaseModel):
    ...
    allow_access_flag: Optional[StrictBool] = Field(default=None, alias="allowAccessFlag")
    ...
    __properties: ClassVar[List[str]] = ["_info", "allowAccessFlag", "department", "id", "location", "member"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if allow_access_flag (nullable) is None
        # and model_fields_set contains the field
        if self.allow_access_flag is None and "allow_access_flag" in self.model_fields_set:
            _dict['allowAccessFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SalesTeamMember) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "allowAccessFlag": obj.get("allowAccessFlag"),
