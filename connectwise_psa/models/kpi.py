...
class KPI(BaseModel):
    ...
    KPI
    """ # noqa: E501
    category: Optional[KPICategoryReference] = None
    date_filter: Optional[StrictStr] = Field(default=None, alias="dateFilter")
    ...
    __properties: ClassVar[List[str]] = ["category", "dateFilter", "id", "inactiveFlag", "name", "sortOrder"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in KPI) in the input: " + _key)

        _obj = cls.model_validate({
            "category": KPICategoryReference.from_dict(obj.get("category")) if obj.get("category") is not None else None,
