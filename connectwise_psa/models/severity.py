...
class Severity(BaseModel):
    ...
    description: StrictStr = Field(description=" Max length: 200;")
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "description", "id", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Severity) in the input: " + _key)
