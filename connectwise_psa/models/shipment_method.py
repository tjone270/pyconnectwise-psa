...
class ShipmentMethod(BaseModel):
    ...
    tracking_url: Optional[StrictStr] = Field(default=None, description=" Max length: 200;", alias="trackingUrl")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "id", "name", "trackingUrl"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ShipmentMethod) in the input: " + _key)
