...
class PurchaseOrderStatus(BaseModel):
    ...
    default_closed_flag: Optional[StrictBool] = Field(default=None, alias="defaultClosedFlag")
    default_flag: Optional[StrictBool] = Field(default=None, alias="defaultFlag")
    email_template: Optional[PurchaseOrderStatusEmailTemplateReference] = Field(default=None, alias="emailTemplate")
    ...
    __properties: ClassVar[List[str]] = ["_info", "closedFlag", "defaultClosedFlag", "defaultFlag", "emailTemplate", "id", "inactiveFlag", "name", "sortOrder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if default_closed_flag (nullable) is None
        # and model_fields_set contains the field
        if self.default_closed_flag is None and "default_closed_flag" in self.model_fields_set:
            _dict['defaultClosedFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PurchaseOrderStatus) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "closedFlag": obj.get("closedFlag"),
            "defaultClosedFlag": obj.get("defaultClosedFlag"),
            "defaultFlag": obj.get("defaultFlag"),
            "emailTemplate": PurchaseOrderStatusEmailTemplateReference.from_dict(obj.get("emailTemplate")) if obj.get("emailTemplate") is not None else None,
            "id": obj.get("id"),
