...
class Survey(BaseModel):
    ...
    instructions: Optional[StrictStr] = Field(default=None, description=" Max length: 1000;")
    name: StrictStr = Field(description=" Max length: 50;")
    __properties: ClassVar[List[str]] = ["_info", "id", "inactiveFlag", "instructions", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Survey) in the input: " + _key)
