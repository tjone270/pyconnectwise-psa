...
class ReportCardDetail(BaseModel):
    ...
    kpi: Optional[KPIReference] = None
    ...
    __properties: ClassVar[List[str]] = ["_info", "id", "kpi", "reportCard", "sortOrder"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ReportCardDetail) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "id": obj.get("id"),
            "kpi": KPIReference.from_dict(obj.get("kpi")) if obj.get("kpi") is not None else None,
