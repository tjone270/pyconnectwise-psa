...
class Track(BaseModel):
    ...
    notify_action_ids: Optional[List[StrictInt]] = Field(default=None, alias="notifyActionIds")
    __properties: ClassVar[List[str]] = ["_info", "id", "inactiveFlag", "name", "notifyActionIds"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Track) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "notifyActionIds": obj.get("notifyActionIds")
        })
        return _obj
