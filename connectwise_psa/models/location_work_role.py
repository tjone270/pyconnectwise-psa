...
class LocationWorkRole(BaseModel):
    ...
    work_role_inactive_flag: Optional[StrictBool] = Field(default=None, alias="workRoleInactiveFlag")
    __properties: ClassVar[List[str]] = ["_info", "id", "location", "workRole", "workRoleInactiveFlag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if work_role_inactive_flag (nullable) is None
        # and model_fields_set contains the field
        if self.work_role_inactive_flag is None and "work_role_inactive_flag" in self.model_fields_set:
            _dict['workRoleInactiveFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LocationWorkRole) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "workRoleInactiveFlag": obj.get("workRoleInactiveFlag")
        })
        return _obj
