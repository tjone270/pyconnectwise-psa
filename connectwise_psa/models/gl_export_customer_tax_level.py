...
class GLExportCustomerTaxLevel(BaseModel):
    ...
    """ # noqa: E501
    agency_xref: Optional[StrictStr] = Field(default=None, alias="agencyXref")
    ...
    __properties: ClassVar[List[str]] = ["agencyXref", "taxCodeXref", "taxLevel", "taxRate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in GLExportCustomerTaxLevel) in the input: " + _key)
