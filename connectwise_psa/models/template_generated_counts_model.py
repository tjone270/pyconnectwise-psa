...
class TemplateGeneratedCountsModel(BaseModel):
    ...
    """ # noqa: E501
    schedule_count: Optional[StrictInt] = Field(default=None, alias="scheduleCount")
    service_count: Optional[StrictInt] = Field(default=None, alias="serviceCount")
    __properties: ClassVar[List[str]] = ["scheduleCount", "serviceCount"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TemplateGeneratedCountsModel) in the input: " + _key)

        _obj = cls.model_validate({
            "scheduleCount": obj.get("scheduleCount"),
