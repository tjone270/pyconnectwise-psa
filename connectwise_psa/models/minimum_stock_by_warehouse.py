...
class MinimumStockByWarehouse(BaseModel):
    ...
    minimum_stock: Optional[StrictInt] = Field(alias="minimumStock")
    warehouse: WarehouseReference
    __properties: ClassVar[List[str]] = ["_info", "id", "minimumStock", "warehouse"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if minimum_stock (nullable) is None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MinimumStockByWarehouse) in the input: " + _key)
