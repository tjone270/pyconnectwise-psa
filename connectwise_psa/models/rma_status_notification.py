...
class RmaStatusNotification(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="RMA Status Notification sendEmail must be entered if the notify type is \"Email Address\". Max length: 50;")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in RmaStatusNotification) in the input: " + _key)
