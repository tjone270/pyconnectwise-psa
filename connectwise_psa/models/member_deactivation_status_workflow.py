...
class MemberDeactivationStatusWorkflow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["count", "id", "name", "reAssignToMember"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MemberDeactivationStatusWorkflow) in the input: " + _key)
