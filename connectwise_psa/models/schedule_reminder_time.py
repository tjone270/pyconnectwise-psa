...
class ScheduleReminderTime(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description=" Max length: 10;")
    time: Optional[StrictInt] = Field(default=None, description="Time is calculated in minutes.")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "id", "name", "time"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ScheduleReminderTime) in the input: " + _key)
