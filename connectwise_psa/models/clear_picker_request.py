...
class ClearPickerRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["member", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Company', 'Vendor'):
            raise ValueError("must be one of enum values ('Company', 'Vendor')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ClearPickerRequest) in the input: " + _key)
