...
class SecurityRole(BaseModel):
    ...
    role_type: Optional[StrictStr] = Field(default=None, description=" Max length: 30;", alias="roleType")
    __properties: ClassVar[List[str]] = ["_info", "adminFlag", "id", "inactiveFlag", "name", "roleType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SecurityRole) in the input: " + _key)
