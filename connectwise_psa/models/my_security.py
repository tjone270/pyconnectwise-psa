...
class MySecurity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "addLevel", "customFlag", "deleteLevel", "editLevel", "id", "inquireLevel", "member", "moduleDescription", "moduleFunctionDescription", "moduleFunctionIdentifier", "moduleFunctionName", "moduleIdentifier", "moduleName", "myAllFlag", "reportFlag", "restrictFlag", "sortOrder"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MySecurity) in the input: " + _key)
