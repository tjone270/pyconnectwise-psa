...
class CorporateStructureInfo(BaseModel):
    ...
    base_currency: Optional[CurrencyReference] = Field(default=None, alias="baseCurrency")
    group_caption: Optional[StrictStr] = Field(default=None, alias="groupCaption")
    id: Optional[StrictInt] = None
    location_caption: Optional[StrictStr] = Field(default=None, alias="locationCaption")
    __properties: ClassVar[List[str]] = ["_info", "baseCurrency", "groupCaption", "id", "locationCaption"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CorporateStructureInfo) in the input: " + _key)
