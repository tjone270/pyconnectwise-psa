...
class AccountingBatch(BaseModel):
    ...
    batch_identifier: Optional[StrictStr] = Field(default=None, alias="batchIdentifier")
    closed_flag: Optional[StrictBool] = Field(default=None, alias="closedFlag")
    export_expenses_flag: Optional[StrictBool] = Field(default=None, alias="exportExpensesFlag")
    export_invoices_flag: Optional[StrictBool] = Field(default=None, alias="exportInvoicesFlag")
    export_products_flag: Optional[StrictBool] = Field(default=None, alias="exportProductsFlag")
    id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_info", "batchIdentifier", "closedFlag", "exportExpensesFlag", "exportInvoicesFlag", "exportProductsFlag", "id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AccountingBatch) in the input: " + _key)
