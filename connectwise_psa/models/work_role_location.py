...
class WorkRoleLocation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "hourlyRate", "id", "location", "workRole"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in WorkRoleLocation) in the input: " + _key)
