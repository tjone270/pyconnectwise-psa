...
class ConfigurationTypeQuestionValue(BaseModel):
    ...
    question: Optional[ConfigurationTypeQuestionReference] = None
    value: StrictStr = Field(description=" Max length: 1000;")
    __properties: ClassVar[List[str]] = ["_info", "configurationType", "defaultFlag", "id", "inactiveFlag", "question", "value"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ConfigurationTypeQuestionValue) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "question": ConfigurationTypeQuestionReference.from_dict(obj.get("question")) if obj.get("question") is not None else None,
            "value": obj.get("value")
        })
        return _obj
