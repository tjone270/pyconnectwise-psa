...
class ContactContactTypeAssociationContactTypeAssociation(BaseModel):
    """
    ...
    type: Optional[ContactTypeReference] = None
    __properties: ClassVar[List[str]] = ["_info", "contact", "id", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ContactContactTypeAssociationContactTypeAssociation) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "contact": ContactReference.from_dict(obj.get("contact")) if obj.get("contact") is not None else None,
            "id": obj.get("id"),
            "type": ContactTypeReference.from_dict(obj.get("type")) if obj.get("type") is not None else None
        })
        return _obj
