...
class SchedulingMemberInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "defaultEmail", "firstName", "fullName", "id", "identifier", "inactiveFlag", "lastName", "middleInitial"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SchedulingMemberInfo) in the input: " + _key)
