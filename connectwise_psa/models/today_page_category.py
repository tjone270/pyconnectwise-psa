...
class TodayPageCategory(BaseModel):
    ...
    sort_order: Optional[StrictInt] = Field(alias="sortOrder")
    __properties: ClassVar[List[str]] = ["_info", "id", "location", "name", "sortOrder"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TodayPageCategory) in the input: " + _key)
