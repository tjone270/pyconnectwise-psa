...
class CurrencyReference(BaseModel):
    ...
    currency_identifier: Optional[StrictStr] = Field(default=None, alias="currencyIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["_info", "currencyCode", "currencyIdentifier", "decimalSeparator", "displayIdFlag", "displaySymbolFlag", "id", "name", "negativeParenthesesFlag", "numberOfDecimals", "rightAlign", "symbol", "thousandsSeparator"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CurrencyReference) in the input: " + _key)
