...
class Member(BaseModel):
    ...
    ldap_user_name: Optional[StrictStr] = Field(default=None, description=" Max length: 50;", alias="ldapUserName")
    ...
    sso_settings: Optional[MemberSsoSettingsReference] = Field(default=None, alias="ssoSettings")
    ...
    __properties: ClassVar[List[str]] = ["_info", "adminFlag", "agreementInvoicingDisplayOptions", "allowExpensesEnteredAgainstCompaniesFlag", "allowInCellEntryOnTimeSheet", "authenticationServiceType", "autoPopupQuickNotesWithStopwatch", "autoStartStopwatch", "billableForecast", "calendar", "calendarSyncIntegrationFlag", "clientId", "companyActivityTabFormat", "copyColumnLayoutsAndFilters", "copyPodLayouts", "copySharedDefaultViews", "country", "customFields", "dailyCapacity", "daysTolerance", "defaultDepartment", "defaultEmail", "defaultLocation", "defaultPhone", "directionalSync", "disableOnlineFlag", "employeeIdentifer", "enableLdapAuthenticationFlag", "enableMobileFlag", "enableMobileGpsFlag", "enterTimeAgainstCompanyFlag", "excludedProjectBoardIds", "excludedServiceBoardIds", "expenseApprover", "firstName", "fromMemberRecId", "fromMemberTemplateRecId", "globalSearchDefaultSort", "globalSearchDefaultTicketFilter", "hideMemberInDispatchPortalFlag", "hireDate", "homeEmail", "homeExtension", "homePhone", "hourlyCost", "hourlyRate", "id", "identifier", "inactiveDate", "inactiveFlag", "includeInUtilizationReportingFlag", "invoiceScreenDefaultTabFormat", "invoiceTimeTabFormat", "invoicingDisplayOptions", "lastLogin", "lastName", "ldapConfiguration", "ldapUserName", "licenseClass", "mapiName", "memberPersonas", "middleInitial", "minimumHours", "mobileEmail", "mobileExtension", "mobilePhone", "notes", "office365", "officeEmail", "officeExtension", "officePhone", "partnerPortalFlag", "password", "phoneIntegrationType", "phoneSource", "photo", "primaryEmail", "projectDefaultBoard", "projectDefaultDepartment", "projectDefaultLocation", "reportCard", "reportsTo", "requireExpenseEntryFlag", "requireStartAndEndTimeOnTimeEntryFlag", "requireTimeSheetEntryFlag", "restrictDefaultSalesTerritoryFlag", "restrictDefaultWarehouseBinFlag", "restrictDefaultWarehouseFlag", "restrictDepartmentFlag", "restrictLocationFlag", "restrictProjectDefaultDepartmentFlag", "restrictProjectDefaultLocationFlag", "restrictScheduleFlag", "restrictServiceDefaultDepartmentFlag", "restrictServiceDefaultLocationFlag", "salesDefaultLocation", "scheduleCapacity", "scheduleDefaultDepartment", "scheduleDefaultLocation", "securityLocation", "securityRole", "serviceBoardTeamIds", "serviceDefaultBoard", "serviceDefaultDepartment", "serviceDefaultLocation", "serviceLocation", "signature", "ssoSettings", "structureLevel", "stsUserAdminUrl", "teams", "timeApprover", "timeReminderEmailFlag", "timeSheetStartDate", "timeZone", "timebasedOneTimePasswordActivated", "title", "toastNotificationFlag", "token", "type", "useBrowserLanguageFlag", "vendorNumber", "warehouse", "warehouseBin", "workRole", "workType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sso_settings
        if self.sso_settings:
            _dict['ssoSettings'] = self.sso_settings.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Member) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "ssoSettings": MemberSsoSettingsReference.from_dict(obj.get("ssoSettings")) if obj.get("ssoSettings") is not None else None,
