...
class CatalogComponent(BaseModel):
    ...
    parent_catalog_item: Optional[CatalogItemReference] = Field(default=None, alias="parentCatalogItem")
    ...
    __properties: ClassVar[List[str]] = ["_info", "catalogItem", "cost", "hideDescriptionFlag", "hideExtendedPriceFlag", "hideItemIdentifierFlag", "hidePriceFlag", "hideQuantityFlag", "id", "parentCatalogItem", "price", "quantity", "sequenceNumber"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of parent_catalog_item
        if self.parent_catalog_item:
            _dict['parentCatalogItem'] = self.parent_catalog_item.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CatalogComponent) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "parentCatalogItem": CatalogItemReference.from_dict(obj.get("parentCatalogItem")) if obj.get("parentCatalogItem") is not None else None,
            "price": obj.get("price"),
