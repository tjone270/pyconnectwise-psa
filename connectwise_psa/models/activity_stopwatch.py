...
class ActivityStopwatch(BaseModel):
    ...
    activity_id: Optional[StrictInt] = Field(alias="activityId")
    activity_mobile_guid: Optional[StrictStr] = Field(default=None, alias="activityMobileGuid")
    ...
    __properties: ClassVar[List[str]] = ["_info", "activityId", "activityMobileGuid", "agreement", "billableOption", "businessUnitId", "dateEntered", "endTime", "id", "internalNotes", "locationId", "member", "mobileGuid", "notes", "startTime", "status", "totalPauseTime", "workRole", "workType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if activity_mobile_guid (nullable) is None
        # and model_fields_set contains the field
        if self.activity_mobile_guid is None and "activity_mobile_guid" in self.model_fields_set:
            _dict['activityMobileGuid'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ActivityStopwatch) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "activityId": obj.get("activityId"),
            "activityMobileGuid": obj.get("activityMobileGuid"),
