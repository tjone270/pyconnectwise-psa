...
class TaxIntegrationInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_info", "enabledFlag", "id", "taxIntegrationType"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TaxIntegrationInfo) in the input: " + _key)
