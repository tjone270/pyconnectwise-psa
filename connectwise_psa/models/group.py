...
class Group(BaseModel):
    ...
    name: StrictStr
    public_description: Optional[StrictStr] = Field(default=None, description=" Max length: 255;", alias="publicDescription")
    public_flag: Optional[StrictBool] = Field(default=None, alias="publicFlag")
    __properties: ClassVar[List[str]] = ["_info", "id", "inactiveFlag", "name", "publicDescription", "publicFlag"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Group) in the input: " + _key)
