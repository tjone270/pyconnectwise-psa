...
class TicketMerge(BaseModel):
    ...
    TicketMerge
    """ # noqa: E501
    merge_ticket_ids: List[StrictInt] = Field(alias="mergeTicketIds")
    status: Optional[ServiceStatusReference] = None
    __properties: ClassVar[List[str]] = ["mergeTicketIds", "status"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TicketMerge) in the input: " + _key)

        _obj = cls.model_validate({
            "mergeTicketIds": obj.get("mergeTicketIds"),
