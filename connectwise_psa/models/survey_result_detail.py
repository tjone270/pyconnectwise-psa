...
class SurveyResultDetail(BaseModel):
    ...
    SurveyResultDetail
    """ # noqa: E501
    answer: Optional[Union[str, Any]] = Field(default=None, description="If question type is Selection, this should be the option array index.")
    question_id: Optional[StrictInt] = Field(default=None, alias="questionId")
    __properties: ClassVar[List[str]] = ["answer", "questionId"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SurveyResultDetail) in the input: " + _key)
