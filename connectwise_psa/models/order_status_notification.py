...
class OrderStatusNotification(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Order Status Notification sendEmail must be entered if the notify type is \"Email Address\". Max length: 50;")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OrderStatusNotification) in the input: " + _key)
