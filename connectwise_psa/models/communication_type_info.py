...
class CommunicationTypeInfo(BaseModel):
    ...
    fax_flag: Optional[StrictBool] = Field(default=None, alias="faxFlag")
    id: Optional[StrictInt] = None
    phone_flag: Optional[StrictBool] = Field(default=None, alias="phoneFlag")
    __properties: ClassVar[List[str]] = ["_info", "defaultFlag", "description", "emailFlag", "faxFlag", "id", "phoneFlag"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CommunicationTypeInfo) in the input: " + _key)
