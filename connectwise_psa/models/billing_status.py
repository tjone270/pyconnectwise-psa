...
class BillingStatus(BaseModel):
    ...
    sent_flag: Optional[StrictBool] = Field(default=None, alias="sentFlag")
    sort_order: Optional[StrictInt] = Field(default=None, alias="sortOrder")
    __properties: ClassVar[List[str]] = ["_info", "closedFlag", "defaultFlag", "id", "inactiveFlag", "name", "sentFlag", "sortOrder"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sent_flag (nullable) is None
        # and model_fields_set contains the field
        if self.sent_flag is None and "sent_flag" in self.model_fields_set:
            _dict['sentFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BillingStatus) in the input: " + _key)
