...
class LinkClicked(BaseModel):
    ...
    date_clicked: Optional[datetime] = Field(default=None, alias="dateClicked")
    id: Optional[StrictInt] = None
    query_string: Optional[StrictStr] = Field(default=None, alias="queryString")
    url: StrictStr = Field(description=" Max length: 2083;")
    __properties: ClassVar[List[str]] = ["campaignId", "contactId", "dateClicked", "id", "queryString", "url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LinkClicked) in the input: " + _key)
