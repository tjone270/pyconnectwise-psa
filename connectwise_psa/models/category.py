...
class Category(BaseModel):
    ...
    price_level_xref: Optional[StrictStr] = Field(default=None, description=" Max length: 10;", alias="priceLevelXref")
    remove_all_locations: Optional[StrictBool] = Field(default=None, alias="removeAllLocations")
    __properties: ClassVar[List[str]] = ["_info", "addAllLocations", "defaultFlag", "id", "inactiveFlag", "integrationXref", "locationIds", "name", "priceLevelXref", "removeAllLocations"]
