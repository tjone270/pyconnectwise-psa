...
class CompanyCompanyTypeAssociationCompanyTypeAssociation(BaseModel):
    """
    ...
    type: Optional[CompanyTypeReference] = None
    __properties: ClassVar[List[str]] = ["_info", "company", "id", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CompanyCompanyTypeAssociationCompanyTypeAssociation) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "company": CompanyReference.from_dict(obj.get("company")) if obj.get("company") is not None else None,
            "id": obj.get("id"),
            "type": CompanyTypeReference.from_dict(obj.get("type")) if obj.get("type") is not None else None
        })
        return _obj
