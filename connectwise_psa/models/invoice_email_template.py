...
class InvoiceEmailTemplate(BaseModel):
    ...
    attach_invoice_flag: Optional[StrictBool] = Field(default=None, alias="attachInvoiceFlag")
    ...
    invoice_status: Optional[BillingStatusReference] = Field(default=None, alias="invoiceStatus")
    ...
    subject: StrictStr = Field(description=" Max length: 200;")
    use_sender_flag: Optional[StrictBool] = Field(default=None, alias="useSenderFlag")
    __properties: ClassVar[List[str]] = ["_info", "attachInvoiceFlag", "body", "copySenderFlag", "emailAddress", "firstName", "id", "invoiceStatus", "lastName", "name", "serviceSurvey", "subject", "useSenderFlag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of invoice_status
        if self.invoice_status:
            _dict['invoiceStatus'] = self.invoice_status.to_dict()
        ...
        # set to None if attach_invoice_flag (nullable) is None
        # and model_fields_set contains the field
        if self.attach_invoice_flag is None and "attach_invoice_flag" in self.model_fields_set:
            _dict['attachInvoiceFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InvoiceEmailTemplate) in the input: " + _key)

        _obj = cls.model_validate({
            "_info": obj.get("_info"),
            "attachInvoiceFlag": obj.get("attachInvoiceFlag"),
            "body": obj.get("body"),
            "copySenderFlag": obj.get("copySenderFlag"),
            "emailAddress": obj.get("emailAddress"),
            "firstName": obj.get("firstName"),
            "id": obj.get("id"),
            "invoiceStatus": BillingStatusReference.from_dict(obj.get("invoiceStatus")) if obj.get("invoiceStatus") is not None else None,
