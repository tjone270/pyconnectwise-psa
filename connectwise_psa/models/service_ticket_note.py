...
class ServiceTicketNote(BaseModel):
    ...
    is_markdown_flag: Optional[StrictBool] = Field(default=None, alias="isMarkdownFlag")
    ...
    __properties: ClassVar[List[str]] = ["_info", "bundledFlag", "contact", "detailDescriptionFlag", "id", "internalAnalysisFlag", "isMarkdownFlag", "issueFlag", "member", "mergedFlag", "noteType", "originalAuthor", "resolutionFlag", "text", "ticket", "timeEnd", "timeStart"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if is_markdown_flag (nullable) is None
        # and model_fields_set contains the field
        if self.is_markdown_flag is None and "is_markdown_flag" in self.model_fields_set:
            _dict['isMarkdownFlag'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ServiceTicketNote) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "isMarkdownFlag": obj.get("isMarkdownFlag"),
