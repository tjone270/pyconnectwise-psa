...
class TestAgreementAdjustment(unittest.TestCase):
    """AgreementAdjustment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgreementAdjustment:
        """Test AgreementAdjustment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgreementAdjustment`
        """
        model = AgreementAdjustment()
        if include_optional:
    ...
    def testAgreementAdjustment(self):
        """Test AgreementAdjustment"""
