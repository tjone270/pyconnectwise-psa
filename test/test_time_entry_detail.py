...
class TestTimeEntryDetail(unittest.TestCase):
    """TimeEntryDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeEntryDetail:
        """Test TimeEntryDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeEntryDetail`
        """
        model = TimeEntryDetail()
        if include_optional:
            return TimeEntryDetail(
                ...
                id = 56,
                lab_start_time = '',
                lab_start_time_active = True,
                schedule_rec_id = 56,
                selected_member_id = '',
                service_rec_id = 56,
                start_time = '',
                stop_watch_rec_id = 56,
                task_rec_id = 56,
                time_entry_view_model = connectwise_psa.models.time_entry_detail_view_model.TimeEntryDetailViewModel(
                    additional_expenses = [
