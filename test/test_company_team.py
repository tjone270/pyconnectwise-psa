...
class TestCompanyTeam(unittest.TestCase):
    """CompanyTeam unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompanyTeam:
        """Test CompanyTeam
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompanyTeam`
        """
        model = CompanyTeam()
        if include_optional:
            return CompanyTeam(
                ...
                member = connectwise_psa.models.member_reference.MemberReference(
                    ...
                    name = '', ),
                sales_flag = True,
                team_role = connectwise_psa.models.team_role_reference.TeamRoleReference(
                    _info = {
                        'key' : ''
                        }, 
                    id = 56, 
