...
class TestEPayConfiguration(unittest.TestCase):
    """EPayConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EPayConfiguration:
        """Test EPayConfiguration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EPayConfiguration`
        """
        model = EPayConfiguration()
        if include_optional:
    ...
    def testEPayConfiguration(self):
        """Test EPayConfiguration"""
