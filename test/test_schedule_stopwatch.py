...
class TestScheduleStopwatch(unittest.TestCase):
    """ScheduleStopwatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleStopwatch:
        """Test ScheduleStopwatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleStopwatch`
        """
        model = ScheduleStopwatch()
        if include_optional:
    ...
    def testScheduleStopwatch(self):
        """Test ScheduleStopwatch"""
