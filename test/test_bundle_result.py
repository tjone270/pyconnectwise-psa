...
class TestBundleResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BundleResult:
        """Test BundleResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleResult`
        """
        model = BundleResult()
        if include_optional:
            return BundleResult(
