...
class TestGLExportPurchaseTransactionDetailTax(unittest.TestCase):
    """GLExportPurchaseTransactionDetailTax unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GLExportPurchaseTransactionDetailTax:
        """Test GLExportPurchaseTransactionDetailTax
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GLExportPurchaseTransactionDetailTax`
        """
        model = GLExportPurchaseTransactionDetailTax()
        if include_optional:
            return GLExportPurchaseTransactionDetailTax(
                account_number = '',
                cogs_xref = '',
                cost = 1.337,
                cost_account_number = '',
    ...
    def testGLExportPurchaseTransactionDetailTax(self):
        """Test GLExportPurchaseTransactionDetailTax"""
