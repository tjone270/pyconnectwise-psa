...
class TestManagementReportNotification(unittest.TestCase):
    """ManagementReportNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManagementReportNotification:
        """Test ManagementReportNotification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManagementReportNotification`
        """
        model = ManagementReportNotification()
        if include_optional:
    ...
    def testManagementReportNotification(self):
        """Test ManagementReportNotification"""
