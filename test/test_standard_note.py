...
class TestStandardNote(unittest.TestCase):
    """StandardNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardNote:
        """Test StandardNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardNote`
        """
        model = StandardNote()
        if include_optional:
            return StandardNote(
