...
class TestActivityStopwatch(unittest.TestCase):
    """ActivityStopwatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivityStopwatch:
        """Test ActivityStopwatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivityStopwatch`
        """
        model = ActivityStopwatch()
        if include_optional:
    ...
    def testActivityStopwatch(self):
        """Test ActivityStopwatch"""
